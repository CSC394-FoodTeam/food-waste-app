# Generated by Django 4.1.6 on 2023-03-06 17:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='recipe',
            name='ingredients',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), default=list, size=None, validators=[django.core.validators.RegexValidator('^[a-z ,-]*$')]),
        ),
        migrations.AlterField(
            model_name='recipe',
            name='restrictions',
